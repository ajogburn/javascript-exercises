...
These JavaScript exercises are intended to complement the JavaScript content on [ajogburn](https://www.theodinproject.com/) (TOP). They should only be done when instructed during the course of the curriculum.
